...
int main() {  // codigo reorganizado con chatgpt 15/05/2025
    ...
    cout << "2. no" << endl;
     ...
     if (opcionMenu == 1)
     {
         ...
         else  if (opcion == 2) 
         {
             ...
             cout << " Oh... PORQUE DEMONIOS HAY CADAVERES AFUERA DE MI CASA, mejor dicho, " << endl;
